 ...
 *
 */
class TaxSearch extends Search {
	public function __construct(){
		$this->_resultClass = 'BeansBooks\\Objects\\Tax';
		$this->_resultKey = 'taxes';
		$this->_url = 'Tax/Search';
	...
	/**
	 * A word query string to search codes for.
	 *
	 * @param $code string
	 */
	public function setCode($code){
		$this->_searchCriteria['search_code'] = $code;
	}
} 